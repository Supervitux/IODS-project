# Vitus Besel, 9.11.2020, this file contains Exc3, data wrangling
# data from https://archive.ics.uci.edu/ml/machine-learning-databases/00320/

# 3) read in data
math <- read.csv("data/student-mat.csv", header = T, sep = ";")
por <- read.csv("data/student-por.csv", header = T, sep = ";")
